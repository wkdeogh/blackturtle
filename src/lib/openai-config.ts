...
export const DEFAULT_OPENAI_COMPANY_PROFILE_MODEL = "gpt-5.6-luna";
export const DEFAULT_OPENAI_COMPANY_MARKET_VIEW_MODEL = "gpt-5.6-luna";
...
export const OPENAI_COMPANY_PROFILE_REASONING_EFFORT = "low" as const;
export const OPENAI_COMPANY_MARKET_VIEW_REASONING_EFFORT = "medium" as const;
