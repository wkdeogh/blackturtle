...
export default async function AnalysisPage() {
  ...
  return <main className="dashboard-page">
    ...
    <div className="page-shell dashboard-content">
      ...
      <ComprehensiveAnalysisPanel initialRun={state.latestRun} initialReport={state.latestReport} currentSnapshotId={snapshot?.id ?? null} migrationReady={state.migrationReady} hasData={hasData} />
    </div>
    <SiteFooter />
  </main>;
}
